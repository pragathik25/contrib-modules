...
class TwigExtension extends \Twig_Extension {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, ModuleHandlerInterface $module_handler, SerializerInterface $serializer, LanguageManagerInterface $language_manager) {
